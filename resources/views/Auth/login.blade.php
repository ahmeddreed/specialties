            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h4 class="card-title text-center pb-0 fs-4">الدخول</h4>

                  </div>

                  <form dir="rtl" class="row g-3 needs-validation"  method="POST" action="{{ route("checkLogin") }}">
                    @csrf
                    @method("post")
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0 fs-5">ليس لدي حساب <a href="{{ route("register") }}">انشاء حساب</a></p>
                    </div>
                  </form>
